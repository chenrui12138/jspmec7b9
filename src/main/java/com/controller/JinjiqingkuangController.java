...
public class JinjiqingkuangController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,JinjiqingkuangEntity jinjiqingkuang, 
		...
		if(tableName.equals("yonghu")) {
			jinjiqingkuang.setZhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,JinjiqingkuangEntity jinjiqingkuang, 
		HttpServletRequest request){
