...
public class XingdongguijiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,XingdongguijiEntity xingdongguiji, 
		HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			xingdongguiji.setZhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XingdongguijiEntity xingdongguiji, 
		HttpServletRequest request){
        EntityWrapper<XingdongguijiEntity> ew = new EntityWrapper<XingdongguijiEntity>();
    	PageUtils page = xingdongguijiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xingdongguiji), params), params));
		request.setAttribute("data", page);
