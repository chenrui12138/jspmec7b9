		...
		<div id="app">
			...
			<div class="forum-container" :style='{"padding":"20px","boxShadow":"0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(17, 16, 17, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0.5px","borderStyle":"solid"}'>
				<form class="layui-form login-form" lay-filter="myForm">
					...
					<div  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(13, 12, 12, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":" 1px ","borderStyle":"solid"}' class="layui-form-item layui-form-text">
					...
					<div class="layui-form-item">
						<div class="layui-input-block" style="text-align: right;margin-right: 30px;">
							<button style="outline:none" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.5)","margin":"10px auto 0","borderColor":"#ccc","backgroundColor":"rgba(255, 192, 1, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"38%","fontSize":"14px","borderStyle":"solid","height":"44px"}' class="layui-btn btn-submit" lay-submit lay-filter="*">修改</button>
							<button style="outline:none":style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.5)","margin":"10px auto","borderColor":"#ccc","backgroundColor":"rgba(75, 92, 196, 1)","color":"rgba(255, 255, 255, 1)","borderRadius":"8px","borderWidth":"0","width":"28%","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="reset" class="layui-btn layui-btn-primary">重置</button>
						</div>
					</div>
				</form>
			</div>
