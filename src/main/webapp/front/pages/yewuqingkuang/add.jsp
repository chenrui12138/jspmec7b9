			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
		                ...
		                <div class="layui-input-block">
		                    <select name="shifouwancheng" id="shifouwancheng" lay-filter="shifouwancheng"  >
		            ...
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">业务情况：</label>
						<div class="layui-input-block">
							<textarea name="yewuqingkuang" id="yewuqingkuang">请输入业务情况</textarea>
						</div>
					</div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='yewuqingkuang'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.yewuqingkuang = true;
                                                continue;
                                        }
                                        if(o=='shifouwancheng'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.shifouwancheng = true;
                                                continue;
                                        }
                                        if(o=='shijian'){
                                                vue.detail[o] = obj[o];
				...
				form.on('submit(*)', function(data) {
					...
					var yewuqingkuang = tinymce.get('#yewuqingkuang').getContent()
					data.yewuqingkuang = yewuqingkuang;
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('yewuqingkuang/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('yewuqingkuang' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
