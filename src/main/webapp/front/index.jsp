...
<html>
	...
	<style type="text/css">
	  ...
	  text-align: center;
		...
		#header .navs li.current {
			...
			background-color: rgba(255, 255, 255, 1);
			box-shadow: 0px 3px  0px rgba(255, 192, 1, 1);
		}
	...
	<body>
		    ...
		    <div class="navs">
				...
				<div class="list">
					<ul>
						...
						<li v-if="chatFlag"><a href="javascript:chatTap()" class="menumain"><i v-if="false" class="layui-icon">&#xe677;</i>在线咨询</a></li>
					</ul>
				</div>
		    </div>
		</div>
		...
		<div id="tabbar" v-if="true" class="tabbar" :style='{"padding":"20px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"-10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 52, 114, 1)","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' style="position: relative;z-index: 999;">
		  ...
		  <div style='box-sizing: border-box;' :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"10px auto 30px auto","borderColor":"rgba(255, 255, 255, 1)","backgroundColor":"rgba(0, 52, 114, 1)","color":"rgba(255, 255, 255, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0px 0 1px 0","width":"40%","lineHeight":"32px","fontSize":"15px","borderStyle":"solid"}' class="desc">什么都能够舍弃，但不可舍弃快乐；什么都能够输掉，但不可输掉笑容！</div>
		</div>
