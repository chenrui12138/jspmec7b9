...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">每日体温管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>每日体温列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">每日体温列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="shenfenzhengSearch" class="form-control form-control-sm" placeholder="请输入身份证" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('tanceshijian')">探测时间<i id="tanceshijianIcon" class="fa fa-sort"></i></th>
											<th>备注</th>
											<th>操作</th>
										</tr>
									</thead>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var zhuzhiCell  = document.createElement('td');
						  ...
						  if(item.zhuzhi != null && item.zhuzhi != "" && item.zhuzhi.length >= 11){
			  	zhuzhiCell.innerHTML = item.zhuzhi.substring(0, 10) + "..."; 
			  }else{
			...
			var tanceshijianCell  = document.createElement('td');

						  tanceshijianCell.innerHTML = item.tanceshijian;


			row.appendChild(tanceshijianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("meiritiwen/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"meiritiwen");
