		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑每日体温</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>每日体温管理</span></li>
								<li class="breadcrumb-item active"><span>编辑每日体温</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">每日体温信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>当前温度</label>
										<input name="dangqianwendu" id="dangqianwendu" name="dangqianwendu" class="form-control" placeholder="当前温度">
									</div>
									<div class="form-group col-md-6">
										<label>探测时间</label>
										<div id="tanceshijianDate" class="input-append date form_datetime">
											<input id="tanceshijian-input" name="tanceshijian" size="20" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "meiritiwen/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("meiritiwen/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("meiritiwen/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("meiritiwen/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#tanceshijian-input").val(getCurDateTime());
			$("#tanceshijianDate").datetimepicker({ 
				autoclose: true,
		...
		function calculationSE(colName){
			//单列求和接口
			http("meiritiwen"+colName,"GET",{
				tableName: "meiritiwen",
				columnName: colName
			},(res)=>{
				if(res.code == 0){
		...
		function dataBind(){
			...
			$("#tanceshijian-input").val(ruleForm.tanceshijian);
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.dangqianwendu != null && res.data.dangqianwendu != ''){
						...
						$("#dangqianwendu").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.tanceshijian != null && res.data.tanceshijian != ''){

						$("#tanceshijian-input").val(res.data.tanceshijian);
						$('#tanceshijianFileName').val(res.data.tanceshijian)
					}
