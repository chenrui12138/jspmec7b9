...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">代办业务管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>代办业务管理</span></li>
								<li class="breadcrumb-item active"><span>代办业务列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">代办业务列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var banliyewuCell  = document.createElement('td');

						  if(item.banliyewu != null && item.banliyewu != "" && item.banliyewu.length >= 11){
			  	banliyewuCell.innerHTML = item.banliyewu.substring(0, 10) + "..."; 
			  }else{
			  	banliyewuCell.innerHTML = item.banliyewu;
			  }


			row.appendChild(banliyewuCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "领取"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'yewuqingkuang','','','')");
			if(crossBtnControl('领取') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("daibanyewu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"daibanyewu");
